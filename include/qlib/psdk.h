...
public:
    ...
    struct data final : public object {
        ...
        auto to_string() {
            return fmt::format("[mode={}, velocity=[{},{},{}], euler_angles=[{},{},{}], "
                               "altitude={}, position=[{},{},{}], number_of_satellites={}, "
                               "compass=[{},{},{}], battery=[{},{},{}]]",
                               mode, velocity[0], velocity[1], velocity[2], euler_angles[0],
    ...
    template <class... Args>
    explicit data_subcriber(Args&&... args) {
        int32_t result{init(std::forward<Args>(args)...)};
        THROW_EXCEPTION(0 == result, "init return {}... ", result);
    }
    ...
    float32_t relative_height() const { return _relative_height; }
...
protected:
    ...
    std::atomic<uint8_t> _status{0u};
    std::atomic<float32_t> _relative_height{0.f};
