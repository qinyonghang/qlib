...
set(cmake_args "-A x64 ${cmake_args}")
...
set(cmake_args "-A Win32 ${cmake_args}")
else()
...
set(cmake_args "-DCMAKE_TOOLCHAIN_FILE=${CMAKE_TOOLCHAIN_FILE} ${cmake_args}")
endif()

if (NOT ${CMAKE_MSVC_RUNTIME_LIBRARY} STREQUAL "")
set(cmake_args "-DCMAKE_MSVC_RUNTIME_LIBRARY=${CMAKE_MSVC_RUNTIME_LIBRARY} ${cmake_args}")
endif()
